...
<body id="page-top">
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto"><p class="lead"></p>perkenalkan nama saya Valerino Rifqi, saya Mahasiswa Universitas Ahmad Dahlan, Jurusan Teknik Informatika</div>
                <div class="col-lg-4 me-auto"><p class="lead"></p>Saya berasal dari Kalimantan Barat, saya anak kedua dari tiga bersaudara, saya memiliki hobi bermain game online dan drum</div>
            </div>
        </div>
    </section>
</body>
